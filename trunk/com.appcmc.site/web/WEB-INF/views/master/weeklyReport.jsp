        ...
        <div id="body">
            <div class="wrapper">
                <div id="body1" class="col"> 
                    ...
                    <input type="hidden" id="weeklyReportHidden" value="${pageContext.request.contextPath}"/>
                    ...
                    <div id="users-contain" class="ui-widget">
                        ...
                        <table id="studentWeeklyReport" class="ui-widget ui-widget-content">
                            ...
                            <tbody>
                                <c:forEach items="${studentsWeeklyList}" var="std">
                                    <tr>
                    ...
                    <div id="studentWeeklyDialog" title="Student Details">
                ...
                <div id="body2" class="col">
                    ...
                    <div class="right-nav">
                        <ul>
                            ...
                            <li class="current"><a href="${pageContext.request.contextPath}/reports/weeklyReport"><s:message code="lbl.enrollment.link.weeklyReport"/></a></li>
