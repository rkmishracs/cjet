            ...
            <div class="wrapper">
                <div id="body1" class="col"> 
                    ...
                    <div id="users-contain" class="ui-widget">
                        ...
                        <h4>Number Of Students Enrolled Today : <c:out value="${fn:length(studentsDailyList)}"/></h4>
                        <div id="exportPdfDiv"><a class="button-h" href="#" id="exportToPdf"><span>Export To PDF</span></a></div>
                        <div style="height:5px;"></div>
                        <table id="studentDailyReport" class="ui-widget ui-widget-content">
                            <thead>
                            ...
                            <tbody>
                                <c:forEach items="${studentsDailyList}" var="std">
                                    <tr>
                ...
                <div id="body2" class="col">
                    ...
                    <div class="right-nav">
                        <ul>
                            ...
                            <li class="current"><a href="${pageContext.request.contextPath}/reports/dailyReport"><s:message code="lbl.enrollment.link.dailyReport"/></a></li>
